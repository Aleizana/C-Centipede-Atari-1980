#ifndef _TurnDownSwitchRight
#define _TurnDownSwitchRight
...
public:
	...
	TurnDownSwitchToRight(const TurnDownSwitchToRight& copyMe) = delete;
	TurnDownSwitchToRight& operator=(const TurnDownSwitchToRight&) = delete;
	~TurnDownSwitchToRight() = default;
