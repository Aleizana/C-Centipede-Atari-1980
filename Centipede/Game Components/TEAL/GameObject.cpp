...
int GameObject::GetDeathHP()
{
	return deathHP;
}

int GameObject::GetMyHealth()
{
	return health;
}
...
int GameObject::GetDmgAmount()
{
	return dmgAmount;
}

GameObject::LifeState GameObject::GetLifeState()
{
	return myState;
}

void GameObject::SetLifeState(LifeState newState)
{
	myState = newState;
}
...
const int GameObject::GetMyRow() const
{
	return 0;
}

const int GameObject::GetMyCol() const
{
	return 0;
}

const int GameObject::GetStartingHP() const
{
	return 0;
}
