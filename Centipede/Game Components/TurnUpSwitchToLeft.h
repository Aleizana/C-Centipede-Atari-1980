#ifndef _TurnUpSwitchLeft
#define _TurnUpSwitchLeft
...
public:
	TurnUpSwitchToLeft();
	TurnUpSwitchToLeft(const TurnUpSwitchToLeft& copyMe) = delete;
	TurnUpSwitchToLeft& operator=(const TurnUpSwitchToLeft&) = delete;
	~TurnUpSwitchToLeft() = default;
...
private:
	...
	const float SpriteScalar_Y_FirstState = -2.0f;	//For setting the size of the sprite, negative so as to flip the sprite on the x-axis to face it up
	const float SpriteScalar_X_FirstState = -2.0f;	//For setting the size of the sprite, negative so as to flip the sprite on the y-axis to face it right
	...
	const float SpriteScalar_Y_SecState = -2.0f;		//For setting the size of the sprite, negative so as to flip the sprite on the x-axis to face it up
	const float SpriteScalar_X_SecState = 2.0f;		//For setting the size of the sprite
