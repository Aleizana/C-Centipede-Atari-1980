#ifndef _PoisonedTurnDownEndLeft
#define _PoisonedTurnDownEndLeft

#include "MoveState.h"

class PoisonedTurnDownEndLeft : public MoveState
{
public:
	PoisonedTurnDownEndLeft();
	PoisonedTurnDownEndLeft(const PoisonedTurnDownEndLeft& copyMe) = delete;
	PoisonedTurnDownEndLeft& operator=(const PoisonedTurnDownEndLeft&) = delete;
	~PoisonedTurnDownEndLeft() = default;
